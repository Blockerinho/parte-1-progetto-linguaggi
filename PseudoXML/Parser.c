...
{
       0,   146,   146,   150,   151,   155,   165,   169,   170,   174,
     175,   179,   180,   181,   182,   186,   187,   191,   192
};
#endif
...
#line 155 "pseudoXMLgrammatica.y"
      ...
      FILE* i = fopen((yyvsp[-4]._string), "r");
      if (!i) {

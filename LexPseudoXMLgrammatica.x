...
module LexPseudoXMLgrammatica where
...
@rsyms = \< "import" \> | \< \/ "import" \> | \< "section" | \= | \> | \< \/ "section" \> | \< "inherit" \> | \< \/ "inherit" \> | \< "field" | \< \/ "field" \> | \$ | \.
...
resWords =
  b "<import>" 8
    (b "</import>" 4
       (b "." 2 (b "$" 1 N N) (b "</field>" 3 N N))
       (b "</section>" 6 (b "</inherit>" 5 N N) (b "<field" 7 N N)))
    (b ">" 12
       (b "<section" 10 (b "<inherit>" 9 N N) (b "=" 11 N N))
       (b "name" 14 (b "false" 13 N N) (b "true" 15 N N)))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
